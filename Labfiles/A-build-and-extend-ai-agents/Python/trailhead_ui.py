"""
<<<<<<<< HEAD:Labfiles/A-build-and-extend-ai-agents/portal-agent/Python/adventure_ui.py
Adventure Works – shared chat UI shell (provided).
========
Trailhead Adventure Works – shared chat UI shell (provided).
>>>>>>>> consolidate-labs-idea:Labfiles/A-build-and-extend-ai-agents/Python/trailhead_ui.py
